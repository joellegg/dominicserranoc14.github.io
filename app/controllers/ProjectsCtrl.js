...
app.controller('ProjectsCtrl', function($scope, $sce) {
  ...
  $scope.urlList = {
    ...
    // {
    //   name: 'Invimtory',
    //   url: $sce.trustAsResourceUrl('https://front-end-capstone.firebaseapp.com/'), desc: 'Sales order and inventory tracking app.',
    ...
    // {
    // name: "Mix 'n' Match",
    // url: $sce.trustAsResourceUrl('https://mix-n-match-89e0e.firebaseapp.com'),
